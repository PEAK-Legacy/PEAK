...
The \module{peak.metamodels} package is currently deprecated.  Much of the code
in it is carried over from the experimental \citetitle{TransWarp} generative
...
exercises the capabilities of the \module{peak.model} subpackage.
