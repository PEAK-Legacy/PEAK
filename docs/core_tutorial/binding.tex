...
Traceback (most recent call last):
  ...
  File "C:\cygwin\home\pje\PEAK\src\peak\binding\once.py", line 177, in usageError
    raise TypeError(
TypeError: Once binding: mkNew was used in a type which does not support active
...
\begin{funcdesc}{Once}{func, name=None, offerAs=(), doc=None, activateUponAssembly=False}
...
\begin{funcdesc}{New}{obtype, name=None, offerAs=(), doc=None,
...
\begin{funcdesc}{Copy}{obj, name=None, offerAs=(), doc=None, activateUponAssembly=False}
...
\begin{funcdesc}{bindToSelf}{name=None, offerAs=(), doc=None}
...
\begin{funcdesc}{requireBinding}{description="", name=None, offerAs=(),
doc=None}
