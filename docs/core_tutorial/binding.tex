...
to.  The object can refer to \samp{self.delegateForInterfaceX.someMethod()},
and have the \samp{delegateForInterfaceX} attribute be a
\class{binding.bindToSelf} instance by default.
\end{funcdesc}
...
XXX Base, Component, bindToParent, getParentComponent, setParentComponent,
getRootComponent, iterParents, ...
