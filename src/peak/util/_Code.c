/* Generated by Pyrex 0.4.6 on Thu Nov 28 18:30:07 2002 */
...
static char *__pyx_srcfile = "C:\\cygwin\\home\\pje\\PEAK\\src/peak/util/_Code.pyx";
...
static int __pyx_f_6opIter___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_cidx), &__pyx_type_codeIndex, "cidx")) {__pyx_lineno = 21; goto __pyx_L1;}
...
static PyObject *__pyx_f_6opIter___next__(PyObject *__pyx_v_self) {
  ...
  int __pyx_1;
  PyObject *__pyx_2 = 0;
  struct __pyx_obj_codeIndex *__pyx_3 = 0;
  Py_INCREF(__pyx_v_self);
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, "StopIteration"); if (!__pyx_2) {__pyx_lineno = 35; goto __pyx_L1;}
    __Pyx_Raise(__pyx_2, 0, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    {__pyx_lineno = 35; goto __pyx_L1;}
    goto __pyx_L2;
  }
  __pyx_L2:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":37 */
  __pyx_3 = ((PyObject *)((struct __pyx_obj_opIter *)__pyx_v_self)->cidx); Py_INCREF(__pyx_3);
  Py_DECREF(((PyObject *)__pyx_v_c));
  ((PyObject *)__pyx_v_c) = __pyx_3;
  __pyx_3 = 0;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":38 */
  ((struct __pyx_obj_opIter *)__pyx_v_self)->pos = (((struct __pyx_obj_codeIndex *)((PyObject *)__pyx_v_c))->opcodeChain[__pyx_v_pos]);

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":39 */
  __pyx_2 = PyInt_FromLong(__pyx_v_pos); if (!__pyx_2) {__pyx_lineno = 39; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static void __pyx_f_9codeIndex___dealloc__(PyObject *__pyx_v_self) {
  ...
  goto __pyx_L0;
  __pyx_L1:;
  __Pyx_WriteUnraisable("_Code.__dealloc__");
  __pyx_L0:;
  Py_DECREF(__pyx_v_self);
}
...
static int __pyx_f_9codeIndex___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyObject_GetAttrString(__pyx_v_codeObject, "co_code"); if (!__pyx_1) {__pyx_lineno = 89; goto __pyx_L1;}
  __pyx_2 = PyObject_AsReadBuffer(__pyx_1,((void (*(*)))(&__pyx_v_ca)),(&__pyx_v_l)); if (__pyx_2 == -1) {__pyx_lineno = 89; goto __pyx_L1;}
  ...
  __pyx_1 = PyObject_GetAttrString(__pyx_v_codeObject, "co_lnotab"); if (!__pyx_1) {__pyx_lineno = 127; goto __pyx_L1;}
  __pyx_2 = PyObject_AsReadBuffer(__pyx_1,((void (*(*)))(&__pyx_v_ca)),(&__pyx_v_end)); if (__pyx_2 == -1) {__pyx_lineno = 127; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  ...
  __pyx_1 = PyObject_GetAttrString(__pyx_v_codeObject, "co_firstlineno"); if (!__pyx_1) {__pyx_lineno = 130; goto __pyx_L1;}
  __pyx_2 = PyInt_AsLong(__pyx_1); if (PyErr_Occurred()) {__pyx_lineno = 130; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_v_arg = __pyx_2;
...
static PyObject *__pyx_f_9codeIndex_opcodeLocations(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (!(__pyx_1 = (__pyx_v_op < 0))) {
    __pyx_1 = (__pyx_v_op > 255);
  }
  if (__pyx_1) {

    /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":168 */
    __pyx_2 = __Pyx_GetName(__pyx_b, "IndexError"); if (!__pyx_2) {__pyx_lineno = 168; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(__pyx_v_op); if (!__pyx_3) {__pyx_lineno = 168; goto __pyx_L1;}
    __Pyx_Raise(__pyx_2, __pyx_3, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    {__pyx_lineno = 168; goto __pyx_L1;}
    goto __pyx_L2;
  }
  __pyx_L2:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":170 */
  __pyx_2 = __Pyx_GetName(__pyx_m, "opIter"); if (!__pyx_2) {__pyx_lineno = 170; goto __pyx_L1;}
  __pyx_3 = PyInt_FromLong((((struct __pyx_obj_codeIndex *)__pyx_v_self)->opcodeHeads[__pyx_v_op])); if (!__pyx_3) {__pyx_lineno = 170; goto __pyx_L1;}
  __pyx_4 = PyTuple_New(2); if (!__pyx_4) {__pyx_lineno = 170; goto __pyx_L1;}
  Py_INCREF(__pyx_v_self);
  PyTuple_SET_ITEM(__pyx_4, 0, __pyx_v_self);
  PyTuple_SET_ITEM(__pyx_4, 1, __pyx_3);
  __pyx_3 = 0;
  __pyx_5 = PyObject_CallObject(__pyx_2, __pyx_4); if (!__pyx_5) {__pyx_lineno = 170; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  Py_XDECREF(__pyx_4);
  Py_XDECREF(__pyx_5);
  __Pyx_AddTraceback("opcodeLocations");
  __pyx_r = 0;
  __pyx_L0:;
  Py_DECREF(__pyx_v_self);
  return __pyx_r;
...
static PyObject *__pyx_f_9codeIndex_operand(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, "IndexError"); if (!__pyx_2) {__pyx_lineno = 176; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(__pyx_v_p); if (!__pyx_3) {__pyx_lineno = 176; goto __pyx_L1;}
    __Pyx_Raise(__pyx_2, __pyx_3, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    {__pyx_lineno = 176; goto __pyx_L1;}
    goto __pyx_L2;
  }
  __pyx_L2:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":178 */
  __pyx_2 = PyInt_FromLong((((struct __pyx_obj_codeIndex *)__pyx_v_self)->operands[__pyx_v_p])); if (!__pyx_2) {__pyx_lineno = 178; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_9codeIndex_opcode(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, "IndexError"); if (!__pyx_2) {__pyx_lineno = 184; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(__pyx_v_p); if (!__pyx_3) {__pyx_lineno = 184; goto __pyx_L1;}
    __Pyx_Raise(__pyx_2, __pyx_3, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    {__pyx_lineno = 184; goto __pyx_L1;}
    goto __pyx_L2;
  }
  __pyx_L2:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":186 */
  __pyx_2 = PyInt_FromLong((((struct __pyx_obj_codeIndex *)__pyx_v_self)->opcodes[__pyx_v_p])); if (!__pyx_2) {__pyx_lineno = 186; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_9codeIndex_offset(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, "IndexError"); if (!__pyx_2) {__pyx_lineno = 192; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(__pyx_v_p); if (!__pyx_3) {__pyx_lineno = 192; goto __pyx_L1;}
    __Pyx_Raise(__pyx_2, __pyx_3, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    {__pyx_lineno = 192; goto __pyx_L1;}
    goto __pyx_L2;
  }
  __pyx_L2:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":194 */
  __pyx_2 = PyInt_FromLong((((struct __pyx_obj_codeIndex *)__pyx_v_self)->offsets[__pyx_v_p])); if (!__pyx_2) {__pyx_lineno = 194; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_9codeIndex_byteLine(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, "IndexError"); if (!__pyx_2) {__pyx_lineno = 200; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(__pyx_v_p); if (!__pyx_3) {__pyx_lineno = 200; goto __pyx_L1;}
    __Pyx_Raise(__pyx_2, __pyx_3, 0);
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    {__pyx_lineno = 200; goto __pyx_L1;}
    goto __pyx_L2;
  }
  __pyx_L2:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/util/_Code.pyx":202 */
  __pyx_2 = PyInt_FromLong((((struct __pyx_obj_codeIndex *)__pyx_v_self)->byteLines[__pyx_v_p])); if (!__pyx_2) {__pyx_lineno = 202; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
DL_EXPORT(void) init_Code(void) {
  ...
  if (PyType_Ready(&__pyx_type_codeIndex) < 0) {__pyx_lineno = 1; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "codeIndex", (PyObject *)&__pyx_type_codeIndex) < 0) {__pyx_lineno = 1; goto __pyx_L1;}
  __pyx_type_opIter.tp_free = _PyObject_GC_Del;
  if (PyType_Ready(&__pyx_type_opIter) < 0) {__pyx_lineno = 1; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "opIter", (PyObject *)&__pyx_type_opIter) < 0) {__pyx_lineno = 1; goto __pyx_L1;}
