/* Generated by Pyrex 0.4.6 on Sat Feb 22 11:10:01 2003 */
...
static PyObject *__pyx_f_14OnceDescriptor___get__(PyObject *__pyx_v_self, void (*__pyx_v_obj), void (*__pyx_v_typ)) {
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_m, "NOT_FOUND"); if (!__pyx_2) {__pyx_lineno = 58; goto __pyx_L1;}
    __pyx_1 = __pyx_v_ob == __pyx_2;
