/* Generated by Pyrex 0.4.6 on Sun Feb 23 20:42:08 2003 */
...
static int __pyx_f_14OnceDescriptor___set__(PyObject *__pyx_v_self, PyObject *__pyx_v_obj, void (*__pyx_v_value)) {
  ...
  __pyx_1 = GET_DICTIONARY(__pyx_v_obj); if (!__pyx_1) {__pyx_lineno = 21; goto __pyx_L1;}
  Py_DECREF(__pyx_v_d);
  __pyx_v_d = __pyx_1;
  __pyx_1 = 0;
  ...
  if (__pyx_2) {
    ...
    if (PyObject_SetItem(__pyx_v_d, __pyx_3, __pyx_1) < 0) {__pyx_lineno = 24; goto __pyx_L1;}
  ...
  /*else*/ {
    ...
    __pyx_3 = ((struct __pyx_obj_OnceDescriptor *)__pyx_v_self)->attrName; Py_INCREF(__pyx_3);
    if (PyObject_DelItem(__pyx_v_d, __pyx_3) < 0) {__pyx_lineno = 27; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  }
  __pyx_L2:;
...
static PyObject *__pyx_f_14OnceDescriptor___get__(PyObject *__pyx_v_self, void (*__pyx_v_obj), void (*__pyx_v_typ)) {
  ...
  if (__pyx_1) {
    ...
    if (__pyx_1) {
      ...
      __pyx_2 = __Pyx_GetName(__pyx_b, "AttributeError"); if (!__pyx_2) {__pyx_lineno = 62; goto __pyx_L1;}
      __Pyx_Raise(__pyx_2, __pyx_v_n, 0);
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      {__pyx_lineno = 62; goto __pyx_L1;}
      goto __pyx_L4;
    }
    __pyx_L4:;
  ...
  __pyx_1 = PyObject_IsTrue(__pyx_v_n); if (__pyx_1 < 0) {__pyx_lineno = 66; goto __pyx_L1;}
  if (!(__pyx_8 = (!__pyx_1))) {
    __pyx_2 = __Pyx_GetName(__pyx_b, "getattr"); if (!__pyx_2) {__pyx_lineno = 66; goto __pyx_L1;}
    __pyx_3 = PyObject_GetAttrString(__pyx_v_ob, "__class__"); if (!__pyx_3) {__pyx_lineno = 66; goto __pyx_L1;}
    __pyx_4 = __Pyx_GetName(__pyx_b, "None"); if (!__pyx_4) {__pyx_lineno = 66; goto __pyx_L1;}
    __pyx_5 = PyTuple_New(3); if (!__pyx_5) {__pyx_lineno = 66; goto __pyx_L1;}
    ...
    __pyx_3 = 0;
    __pyx_4 = 0;
    __pyx_6 = PyObject_CallObject(__pyx_2, __pyx_5); if (!__pyx_6) {__pyx_lineno = 66; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  if (__pyx_8) {
    ...
    __pyx_3 = PyObject_GetAttrString(__pyx_v_self, "usageError"); if (!__pyx_3) {__pyx_lineno = 67; goto __pyx_L1;}
    __pyx_4 = PyTuple_New(0); if (!__pyx_4) {__pyx_lineno = 67; goto __pyx_L1;}
    __pyx_5 = PyObject_CallObject(__pyx_3, __pyx_4); if (!__pyx_5) {__pyx_lineno = 67; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  __pyx_2 = (PyObject *)__pyx_v__NOTFOUND;
  Py_INCREF(__pyx_2);
  if (PyObject_SetItem(__pyx_v_d, __pyx_v_n, __pyx_2) < 0) {__pyx_lineno = 69; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  /*try:*/ {
    ...
    __pyx_4 = PyObject_GetAttrString(__pyx_v_self, "computeValue"); if (!__pyx_4) {__pyx_lineno = 72; goto __pyx_L6;}
    __pyx_3 = PyTuple_New(3); if (!__pyx_3) {__pyx_lineno = 72; goto __pyx_L6;}
    ...
    __pyx_5 = PyObject_CallObject(__pyx_4, __pyx_3); if (!__pyx_5) {__pyx_lineno = 72; goto __pyx_L6;}
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /*except:*/ {
    ...
    __pyx_2 = __Pyx_GetExcValue(); if (!__pyx_2) {__pyx_lineno = 73; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;

    /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":74 */
    if (PyObject_DelItem(__pyx_v_d, __pyx_v_n) < 0) {__pyx_lineno = 74; goto __pyx_L1;}

    /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":75 */
    __Pyx_ReRaise();
    {__pyx_lineno = 75; goto __pyx_L1;}
    goto __pyx_L7;
  }
  __pyx_L7:;

  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":77 */
  if (PyObject_SetItem(__pyx_v_d, __pyx_v_n, __pyx_v_value) < 0) {__pyx_lineno = 77; goto __pyx_L1;}

  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":79 */
...
static PyObject *__pyx_f_21__attrName_Descriptor___get__(PyObject *__pyx_v_self, void (*__pyx_v_obj), void (*__pyx_v_typ)) {
  ...
  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":92 */
  __pyx_1 = (!(__pyx_v_obj != 0));
  if (__pyx_1) {
  ...
  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":95 */
...
static int __pyx_f_21__attrName_Descriptor___set__(PyObject *__pyx_v_self, PyObject *__pyx_v_obj, void (*__pyx_v_value)) {
  ...
  Py_INCREF(__pyx_v_self);
  Py_INCREF(__pyx_v_obj);
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_obj), &__pyx_type_OnceDescriptor, "obj")) {__pyx_lineno = 98; goto __pyx_L1;}
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = __Pyx_GetName(__pyx_b, "None"); if (!__pyx_2) {__pyx_lineno = 100; goto __pyx_L1;}
...
DL_EXPORT(void) init_once(void) {
  ...
  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":6 */

  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":8 */

  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":10 */
  __pyx_1 = PyString_FromString(__pyx_k1); if (!__pyx_1) {__pyx_lineno = 10; goto __pyx_L1;}
  __pyx_2 = PyString_FromString(__pyx_k2); if (!__pyx_2) {__pyx_lineno = 10; goto __pyx_L1;}
  __pyx_3 = PyList_New(1); if (!__pyx_3) {__pyx_lineno = 10; goto __pyx_L1;}
  PyList_SET_ITEM(__pyx_3, 0, __pyx_2);
  __pyx_2 = 0;
  __pyx_4 = __Pyx_Import(__pyx_1, __pyx_3); if (!__pyx_4) {__pyx_lineno = 10; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_5 = PyObject_GetAttrString(__pyx_4, "NOT_FOUND"); if (!__pyx_5) {__pyx_lineno = 10; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "NOT_FOUND", __pyx_5) < 0) {__pyx_lineno = 10; goto __pyx_L1;}
  Py_DECREF(__pyx_5); __pyx_5 = 0;
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  ...
  __pyx_2 = __Pyx_GetName(__pyx_m, "__attrName_Descriptor"); if (!__pyx_2) {__pyx_lineno = 105; goto __pyx_L1;}
  __pyx_1 = PyTuple_New(0); if (!__pyx_1) {__pyx_lineno = 105; goto __pyx_L1;}
  __pyx_3 = PyObject_CallObject(__pyx_2, __pyx_1); if (!__pyx_3) {__pyx_lineno = 105; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  if (PyObject_SetAttrString(__pyx_m, "OnceDescriptor_attrName", __pyx_3) < 0) {__pyx_lineno = 105; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;

  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":107 */
  __pyx_4 = PyString_FromString(__pyx_k3); if (!__pyx_4) {__pyx_lineno = 107; goto __pyx_L1;}
  __pyx_5 = PyString_FromString(__pyx_k4); if (!__pyx_5) {__pyx_lineno = 107; goto __pyx_L1;}
  __pyx_1 = PyList_New(2); if (!__pyx_1) {__pyx_lineno = 107; goto __pyx_L1;}
  PyList_SET_ITEM(__pyx_1, 0, __pyx_4);
  PyList_SET_ITEM(__pyx_1, 1, __pyx_5);
  __pyx_4 = 0;
  __pyx_5 = 0;
  if (PyObject_SetAttrString(__pyx_m, "__all__", __pyx_1) < 0) {__pyx_lineno = 107; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;

  /* "C:\cygwin\home\pje\PEAK\src/peak/binding/_once.pyx":109 */
  __pyx_2 = __Pyx_GetName(__pyx_m, "NOT_FOUND"); if (!__pyx_2) {__pyx_lineno = 109; goto __pyx_L1;}
  __pyx_v__NOTFOUND = ((void (*))__pyx_2);
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  return;
  __pyx_L1:;
  Py_XDECREF(__pyx_1);
